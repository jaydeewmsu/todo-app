    ...
    <div style="width: 480px;"class="max-w-full mx-auto mt-10 px-4 py-8 text-gray-500">
        ...
        <form action="{{route('tasks.store')}}" method="POST">
            ...
            <div class="flex gap-4">
                <button class="block bg-gray-400 py-2 px-4 rounded-lg text-gray-100 focus:outline-none task-btn-ok">Create</button>
                <a href="{{route('tasks.index')}}" class="block bg-red-500 py-2 px-4 rounded-lg text-gray-100 focus:outline-none task-btn-cancel">Cancel</a>
            </div>
        </form>
    </div>
</x-app-layout>
